...
public class FightSpace{
	...
	public void Fight() {
		...
		Fight user = new Fight("캐릭명", "스킬명", 10, 10, 10, 10, 10, 0, 2, 1);
			...
			while (true) {
				System.out.println(emon.getName() + "의 상태 >> " + "체력 : " + emon.getVhp() + "/" + emon.getHp()
						+ " 공격력 : " + emon.getAtt());
				...
				System.out
						.println(emon.getName() + "의 공격으로 " + user.getName() + "는(은) " + emon.getAtt() + "의 데미지를 입었다.");
				...
				if (input == 1) {
					...
					System.out.println(
							user.getName() + "의 공격으로 " + emon.getName() + "는(은) " + user.getAtt() + "의 데미지를 입었다.");
